...
/**
 * @param {BloomDataSmall32B} bloom32b The bloom data to be updated.
 * @param {HashSmall4x8bits} hash4x8bits
 */
export function bloomUpdateSmall(bloom32b, hash4x8bits) {
  ...
  const o0 = bloom32b[bo0 & 0x1f];
  const o1 = bloom32b[bo1 & 0x1f];
  const o2 = bloom32b[bo2 & 0x1f];
  const o3 = bloom32b[bo3 & 0x1f];
  ...
  bloom32b[bo0 & 0x1f] = n0;
  bloom32b[bo1 & 0x1f] = n1;
  bloom32b[bo2 & 0x1f] = n2;
  bloom32b[bo3 & 0x1f] = n3;
}
